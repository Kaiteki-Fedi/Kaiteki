...
abstract class FediverseClientBase<AuthData extends AuthenticationData> {
  ...
  Future<T> sendJsonRequest<T>(
    ...
    var response = await sendRequest(method, endpoint, body: requestBodyJson, contentType: requestContentType);
  ...
  Future<StreamedResponse> sendRequest(HttpMethod method, String endpoint, {String body, String contentType}) async {
