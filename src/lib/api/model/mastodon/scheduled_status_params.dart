...
import 'package:kaiteki/api/model/mastodon/poll.dart';
...
class MastodonScheduledStatusParams {
  ...
  factory MastodonScheduledStatusParams.fromJson(Map<String, dynamic> json) => _$MastodonScheduledStatusParamsFromJson(json);
}