...
final newPostKeySet = LogicalKeySet(LogicalKeyboardKey.keyN);
final replyKeySet = LogicalKeySet(LogicalKeyboardKey.keyR);
final repeatKeySet = LogicalKeySet(LogicalKeyboardKey.keyT);
