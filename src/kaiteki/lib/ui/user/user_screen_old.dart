...
class OldUserScreen extends ConsumerStatefulWidget {
  ...
  const OldUserScreen.fromId(
    this.id, {
    super.key,
  }) : initialUser = null;

  OldUserScreen.fromUser(
    User this.initialUser, {
    super.key,
  }) : id = initialUser.id;

  @override
  ConsumerState<OldUserScreen> createState() => _UserScreenState();
}

class _UserScreenState extends ConsumerState<OldUserScreen>
